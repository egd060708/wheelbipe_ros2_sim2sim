...
#ifndef TEMPLATE_ROS2_CONTROLLER__STATE_STANDING_HPP_
#define TEMPLATE_ROS2_CONTROLLER__STATE_STANDING_HPP_
...
// 站立状态类
class StateStanding : public StateBase
{
public:
  StateStanding(StateMachine* state_machine, rclcpp::Logger logger);
  virtual ~StateStanding() = default;
...
#endif  // TEMPLATE_ROS2_CONTROLLER__STATE_STANDING_HPP_
